      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
                Only if you are verified as a Supervendor, 
                you can view your lead&apos;s contact and a variety of other information about
                their enquiry right from your CRM.
            </Text>
            <Button
              style={button}
              href="https://www.sarangsayang.com/sign-in"
            >
            ...
            <Text style={paragraph}>
              ...
              answers to most questions on our{' '}
